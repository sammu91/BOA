...
public class TRADE_INDOCS_Execute_GBS_trade_Queries {

	public static void create_TRADE_GPSquery (String clientRefNo) {

		String paybatid = null;
		String indocsno = null;
		
		
		String getbatchidquery="select paymentbatchid,batchreferenceno, * from tx_trade_paymentbatch where paymentreferenceno='"+clientRefNo+"'";
