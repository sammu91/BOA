...
public class Calendar_Utility {
	...
	public Calendar_Utility(final WebElement calendarContainer) {
		this.calendarContainer = calendarContainer;
	}

	static final String[] MONTHS = new String[] { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct",
			"Nov", "Dec" };
	...
	private void selectDateByText(final int dd) {
		...
		final List<WebElement> allDates = calendarContainer.findElements(
				By.cssSelector("#ContentPlaceHolder1_txtDateFrom_CalendarExtender_daysBody"+
	...
	int checkYear(final int yyyy) {
		...
		final String title = calendarContainer.findElement(By.className("ajax__calendar_title")).getText();
